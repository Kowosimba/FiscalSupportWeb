...
@section('ticket-content')
    ...
    <div class="page-header mb-3">
        <div class="header-content">
            ...
            <p class="page-subtitle">Review tickets that have been resolved</p>
        </div>
            ...
            <form method="GET" action="{{ route('admin.tickets.solved') }}" class="filter-form">
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="select-wrapper">
                            <select name="technician" id="technician" class="enhanced-select">
                    ...
                    <div class="form-group form-actions">
                        ...
                        <a href="{{ route('admin.tickets.solved') }}" class="btn btn-outline">
                    ...
                    <tbody>
                        @forelse ($tickets as $ticket)
                            <tr class="ticket-row">
                                ...
                                <td>
                                    <span class="status-badge" style="background: #d1fae5; color: #047857; border: 1px solid #34d399;">
