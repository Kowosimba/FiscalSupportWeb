...
<div class="dashboard-container">
    ...
    <div class="dashboard-header mb-2">
        <div class="header-content">
            ...
            <div class="header-meta">
                <span class="badge bg-success">{{ $tickets->total() ?? 0 }} solved</span>
    ...
    <div class="filter-card mb-2">
        <form method="GET" action="{{ route('admin.tickets.solved') }}" class="filter-form">
            <div class="filter-row">
                ...
                <div class="filter-actions">
                    ...
                    <a href="{{ route('admin.tickets.solved') }}" class="btn btn-sm btn-outline-secondary">
                        ...
                        <tr>
                            <td colspan="8" class="empty-state">
                                <div class="empty-content">
                                    ...
                                    <h6>No Solved Tickets</h6>
                                    <p>There are no solved tickets matching your criteria.</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
...
@push('styles')
<style>
/* Updated CSS Variables for Solved Tickets */
:root {
    --primary: #059669;
    --primary-dark: #047857;
    --success: #059669;
...
/* Solved status badge - green theme */
.status-solved {
    background: #DCFCE7;
    color: #166534;
    border: 1px solid #BBF7D0;
...
/* Override Bootstrap pagination colors for solved theme */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showToast(message, type = 'info') {
        ...
        const colors = {
            ...
            'info': 'linear-gradient(135deg, #059669, #047857)' // Changed from blue to green
        };
