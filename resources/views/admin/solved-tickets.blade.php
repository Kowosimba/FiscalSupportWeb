...
<div class="card mb-4">
    <div class="card-body pb-0">
        <form method="GET" action="{{ route('admin.tickets.solved') }}" class="row g-2 align-items-end">
            <div class="col-md-3">
            ...
            <div class="col-md-3 d-flex align-items-center">
                ...
                <a href="{{ route('admin.tickets.solved') }}" class="btn btn-outline-secondary ms-2">
                    Reset
                </a>
            </div>
        </form>
                ...
                <tbody>
                    @forelse ($tickets as $ticket)
                        <tr>
                            ...
                            <td>
                                <span class="badge status-solved">
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="text-center text-muted">No solved tickets found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
