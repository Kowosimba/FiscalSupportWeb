    ...
    <div class="faq-management-container">
        ...
        <div class="page-header-card mb-4">
            <div class="page-header-content">
                ...
                <a href="{{ route('admin.faqs.create') }}" class="btn btn-primary btn-enhanced">
        ...
        <div class="content-card">
            ...
            <div class="content-card-body">
                <div class="table-responsive">
                    <table class="enhanced-table" id="faqsTable">
                        <thead>
                            <tr>
                                <th width="5%"><i class="fa fa-hashtag me-1"></i>#</th>
                                <th width="25%"><i class="fa fa-question me-1"></i>Question</th>
                                <th width="40%"><i class="fa fa-comment me-1"></i>Answer</th>
                                <th width="15%"><i class="fa fa-tag me-1"></i>Category</th>
                                <th width="10%"><i class="fa fa-toggle-on me-1"></i>Status</th>
                                <th width="15%"><i class="fa fa-cog me-1"></i>Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="faq-answer">{!! Str::limit(strip_tags($faq->answer), 100) !!}</div>
                                </td>
                                <td>
                                    <span class="category-badge {{ $faq->category ? 'category-filled' : 'category-empty' }}">
                                        <i class="fa fa-tag me-1"></i>
                                        {{ $faq->category->name ?? 'Uncategorized' }}
                                    </span>
                                </td>
                                <td>
                                    <span class="status-badge status-{{ $faq->is_active ? 'active' : 'inactive' }}">
                                        <i class="fa fa-{{ $faq->is_active ? 'check-circle' : 'times-circle' }} me-1"></i>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <button class="action-btn delete-btn delete-faq" 
                                                data-id="{{ $faq->id }}"
                                                title="Delete FAQ">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content custom-modal">
                ...
                <div class="modal-body custom-modal-body">
                    <p class="mb-0">Are you sure you want to delete this FAQ? This action cannot be undone.</p>
                </div>
                <div class="modal-footer custom-modal-footer">
                    ...
                    <form id="deleteForm" method="POST" class="d-inline">
                        ...
                        <button type="submit" class="btn btn-danger btn-enhanced">
                            <i class="fa fa-trash me-2"></i>Delete FAQ
                        </button>
                    </form>
                </div>
            </div>
