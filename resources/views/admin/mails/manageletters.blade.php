...
<div class="container-fluid">
        ...
        <div class="page-header-content">
            <div>
                ...
                <p class="page-subtitle">
                    Manage your newsletter campaigns, send or edit drafts.
                </p>
            </div>
            <a href="{{ route('admin.newsletters.create') }}" class="btn btn-primary btn-enhanced">
    ...
    <div class="content-card">
        <div class="content-card-header">
            <h5 class="card-title"><i class="fa fa-list me-2"></i>Campaigns List</h5>
        </div>
                ...
                <table class="enhanced-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.newsletters.show', $campaign) }}" class="action-btn view-btn" title="View">
                                    <i class="fa fa-eye"></i>
                                </a>
                                @if(!$campaign->sent_at)
                                    <a href="{{ route('admin.newsletters.edit', $campaign) }}" class="action-btn edit-btn" title="Edit">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <form action="{{ route('admin.newsletters.send', $campaign) }}" method="POST" class="d-inline">
                                        @csrf
                                        <button type="submit" class="action-btn send-btn" title="Send" onclick="return confirm('Send this newsletter to all subscribers?')">
